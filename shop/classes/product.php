...
<?php
	...
	class product 
	{
		...
		public function getLatestSony(){
			$query = "SELECT * FROM product where `product`.`brand_id`=11 order by product_id desc LIMIT 1 ";
			$result = $this->db->select($query);
			return $result;
		}
		public function getLatestNikon(){
			$query = "SELECT * FROM product where `product`.`brand_id`=8 order by product_id desc LIMIT 1 ";
			$result = $this->db->select($query);
			return $result;
		}
		public function getLatestKodak(){
			$query = "SELECT * FROM product where `product`.`brand_id`=7 order by product_id desc LIMIT 1 ";
			$result = $this->db->select($query);
			return $result;
		}
		public function getLatestCanon(){
			$query = "SELECT * FROM product where `product`.`brand_id`=5 order by product_id desc LIMIT 1 ";
			$result = $this->db->select($query);
			return $result;
		}
}
