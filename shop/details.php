    	...
    	<div class="section group">
			...
			?>
				...
				<div class="rightsidebar span_3_of_1">
					...
					<ul>
						<?php 
							$get_all_category = $category->show_category_FE();
							if ($get_all_category) {
								while($res = $get_all_category->fetch_assoc()){														
						?>

				      <li><a href="productbycat.php?cat_id=<?php echo $res['cat_id'] ?>"><?php echo $res['cat_name'] ?></a></li>
